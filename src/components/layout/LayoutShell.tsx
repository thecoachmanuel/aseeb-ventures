...
export function LayoutShell({ children, navItems }: { children: React.ReactNode; navItems: any[] }) {
  ...
  return (
    <>
      ...
      <Footer />
      <a
        href="https://wa.me/2348056165347"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] text-white rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-200 flex items-center justify-center"
