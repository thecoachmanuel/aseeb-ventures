        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            <div>
              ...
              <input id="email" type="email" placeholder="you@example.com" required className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-crop-green focus:border-transparent" />
            </div>
            <div>
          ...
          <div className="mt-4 text-center">
            <a href="/register" className="text-sm text-crop-green hover:underline">Don&apos;t have an account? Register</a>
          </div>
        </div>
      </div>
    </section>
