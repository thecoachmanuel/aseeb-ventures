    ...
    <section className="py-16 lg:py-24">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="prose prose-gray max-w-none space-y-6 text-gray-600 leading-relaxed">
          ...
          <p>We use the information we collect to provide, maintain, and improve our services; to send you technical notices and support messages; to communicate with you about products, services, and events offered by Aseeb Ventures; and to monitor and analyze trends and usage.</p>
          ...
          <p>If you have any questions about this Privacy Policy, please contact us at support@aseeb-ventures.com.</p>
        </div>
      </div>
    </section>
  );
