...
const serviceData: Record<string, { title: string; desc: string; category: string }> = {
  "laboratory-services": { title: "Laboratory Services", category: "laboratory", desc: "We offer a wide range of state-of-the-art tests in agricultural, environmental, and food safety analysis. Our laboratory is ISO/IEC 17025 accredited (KENAS) and provides testing for soil fertility, water quality, food safety, pesticide residues, fertilizer quality, animal feed, plant disease, and nematode analysis." },
