    ...
    <section className="py-16 lg:py-24">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="prose prose-gray max-w-none space-y-6 text-gray-600 leading-relaxed">
          <p>Welcome to Cropnuts. By accessing our website and using our services, you agree to comply with and be bound by the following terms and conditions.</p>

          <h2 className="text-xl font-bold text-crop-dark mt-8">1. Services</h2>
          <p>Crop Nutrition Laboratory Services Ltd provides agricultural laboratory testing, agronomy advisory services, and AgTech solutions. All services are subject to availability and our standard terms of engagement.</p>
          ...
          <p>All content, trademarks, logos, and intellectual property on this website are owned by or licensed to Cropnuts. Reproduction is prohibited without express written permission.</p>

          <h2 className="text-xl font-bold text-crop-dark mt-8">4. Limitation of Liability</h2>
          <p>Cropnuts shall not be liable for any indirect, incidental, special, or consequential damages resulting from the use or inability to use our services or website.</p>
