    ...
    <html lang="en">
      <body className="min-h-screen flex flex-col bg-white antialiased">
        ...
        <a
          ...
          className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-200 flex items-center gap-2 px-4 py-3 group"
